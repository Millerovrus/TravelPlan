            ...
            <div class="user-info-block">
                ...
                <div class="user-body">
                    <div class="tab-content">
                        ...
                        <#--<span class="btn-group">-->
                        <#--&lt;#&ndash;<button class="js-cal-option btn btn-default {{: mode==='year'? 'active':'' }}" data-mode="year">Year</button>&ndash;&gt;-->
                        ...
                        <#--$t.popover({content: '', html: true, placement: 'auto left'}).popover('toggle');-->
                            ...
                            <div class="container-fluid">
                                <div class="row row-striped">
                                    <div class="col-sm-2 text-right pull-left">
                                        ...
                                        <h2 class="header-text">APR</h2>
                                    </div>
                                    <div class="col-sm-10">
                                        <h3 class="text-uppercase header-text"><b> Moscow - Voronezh </b></h3>
                                        <ul class="list-inline">
                                            <li class="list-inline-item"><i class="fa fa-calendar-o" aria-hidden="true"></i> Friday</li>
                                            <li class="list-inline-item"><i class="fa fa-clock-o" aria-hidden="true"></i> 08:30 AM</li>
                                            <li class="list-inline-item"><i class="fa fa-location-arrow" aria-hidden="true"></i> Moscow</li>
                                        </ul>
                                        <br>
                                        <p>
                                ...
                                <div class="row row-striped">
                                    <div class="col-sm-2 text-right">
                                        ...
                                        <h2 class="header-text">MAY</h2>
                                    </div>
                                    <div class="col-sm-10">
                                        <h3 class="text-uppercase header-text"><strong> Voronezh - Prague </strong></h3>
                                        <ul class="list-inline">
                                            <li class="list-inline-item"><i class="fa fa-calendar-o" aria-hidden="true"></i> Saturday</li>
                                            <li class="list-inline-item"><i class="fa fa-clock-o" aria-hidden="true"></i> 09:50 PM</li>
                                            <li class="list-inline-item"><i class="fa fa-location-arrow" aria-hidden="true"></i> Moscow</li>
                                        </ul>
                                        <br>
                                        <p>
                                            <b class="font-weight">Transit:</b> Voronezh - Moscow <br>
