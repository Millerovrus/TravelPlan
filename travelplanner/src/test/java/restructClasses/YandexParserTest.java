...
public class YandexParserTest {
    ...
    public void tetet(){
        ...
        InitializatorApi initializatorApi = preparingDataService.prepareData("Voronezh", "Moscow", "(51.6754966, 39.20888230000003)","(55.755826, 37.617299900000035)","2018-03-19", 1, 0);
        ...
        List<Edge> list = yandexParser.findEdgesFromTo(initializatorApi.getFrom(),initializatorApi.getTo(),initializatorApi.getDeparture(),initializatorApi.getNumberOfAdults(),initializatorApi.getNumberOfChildren());
