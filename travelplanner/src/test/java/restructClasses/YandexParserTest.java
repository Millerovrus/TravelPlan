...
public class YandexParserTest {
    ...
    public void tetet(){
        ...
        SearchInputParameters searchInputParameters = preparingDataService.prepareData("Voronezh", "Moscow", "(51.6754966, 39.20888230000003)","(55.755826, 37.617299900000035)","2018-03-19", 1, 0);

        WebDriver driver = WebParser.getDriver();

        YandexParser yandexParser = new YandexParser(WebParser.getDriver());
        List<Edge> list = yandexParser.findEdgesFromTo(searchInputParameters.getFrom(), searchInputParameters.getTo(), searchInputParameters.getDeparture(), searchInputParameters.getNumberOfAdults(), searchInputParameters.getNumberOfChildren());
